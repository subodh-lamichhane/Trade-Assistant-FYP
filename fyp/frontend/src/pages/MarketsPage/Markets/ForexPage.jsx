...
const ForexPage = () => {
    ...
    const generatePrediction = (type, currentSymbol, currentTimeframe) => {
        // Extract the currency pair from the symbol (e.g., "OANDA:EURUSD" -> "EUR/USD")
        const pair = currentSymbol.split(":")[1];
        const formattedPair = pair ? `${pair.substring(0, 3)}/${pair.substring(3)}` : "EUR/USD";
        ...
        if (type === "ICT") {
            predictionText = `Based on ICT analysis, ${formattedPair} is expected to move in a ${strength} ${direction} direction on the ${timeframeDisplay} timeframe.`;
...
Note: In ranging markets, it's often best to wait for a clear breakout before entering a position.`;
            ...
            predictionText = `Based on SMC analysis, ${formattedPair} is expected to move in a ${strength} ${direction} direction on the ${timeframeDisplay} timeframe.`;
        ...
        <div className="forex-page">
            ...
            <div className="content-container">
                ...
                <div className="forex-chart-container">
                    <ForexChart symbol={symbol} indicatorType={indicatorType} timeframe={timeframe} />
                </div>
